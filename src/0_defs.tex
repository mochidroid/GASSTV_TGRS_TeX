...
\def\VecSpectralDiff#1{\mathbf{d}_{#1}}
\def\IndexSpecNodeOne{p}
\def\IndexSpecNodeTwo{q}
...
\def\GraphLaplacianSegment#1{\mathbf{L}^{(#1)}}
\def\SpectralGraphLaplacian{\mathbf{L}_{\SpectralGraph}}
